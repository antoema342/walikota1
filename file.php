<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        $query = mysqli_query($config, "SELECT * FROM tbl_disposisisurat WHERE id_disposisi=$id_surat");
                    ...
                    <div class="row jarak-form">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        <td width="13%">No.</td>
                                                        <td width="1%">:</td>
                                                        <td width="86%">'.$row['id_disposisi'].'</td>
                                                    </tr>
                                                    <tr>
                                                        <td width="13%">SKPD/UKPD</td>
                                                        <td width="1%">:</td>
                                                        <td width="86%">'.$row['skpd_ukpd'].'</td>
                                                    </tr>
                        ...
                        if(empty($row['foto'])){
                            ...
                            if(in_array($eks, $ekstensi) == true){
                                echo '<img class="gbr" data-caption="'.date('d M Y', strtotime($row['tgl_surat'])).'" src="./photo/'.$row['foto'].'"/>';
                            } else {
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/surat_masuk/'.$row['foto'].'" target="_blank">'.$row['foto'].'</a>
                                                        </div>
                                                    </div>
                                                </div>
