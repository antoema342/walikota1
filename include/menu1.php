            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="?page=tsm">Surat Disposisi</a></li>
                                <li><a href="?page=tsk">Notulen Rapat</a></li>
                            </ul>
                        </div>
                   </li>
                </ul>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            ...
            <li><a class="dropdown-button" href="#!" data-activates="transaksi">Transaksi Surat <i class="material-icons md-18">arrow_drop_down</i></a></li>
                <ul id='transaksi' class='dropdown-content'>
                    <li><a href="?page=tsm">Surat Disposisi</a></li>
                    <li><a href="?page=ref">Notulen Rapat</a></li>
                    <li><a href="?page=tsm">Surat Disposisi</a></li>
                    <li><a href="?page=ref">Notulen Rapat</a></li>
            ...
            <?php               }
            ?>
            <li><a class="dropdown-button" href="#!" data-activates="agenda">Laporan <i class="material-icons md-18"></i></a></li>
