...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            ...
            <li><a class="dropdown-button" href="#!" data-activates="transaksi">Disposisi Masuk <i class="material-icons md-18">arrow_drop_down</i></a></li>
                <ul id='transaksi' class='dropdown-content'>
                    <li><a href="?page=tsm1">Surat</a></li>
                    <li><a href="?page=tsm1telepon">Telepon</a></li>
                    <li><a href="?page=tsm1dll">Dan Lain-lain</a></li>

                </ul>
                
            <li><a class="dropdown-button" href="#!" data-activates="agenda">Rekap Laporan <i class="material-icons md-18"></i></a></li>
