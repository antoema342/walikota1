        ...
        if($_SESSION['admin'] != 1){
            ...
            if(isset($_REQUEST['act'])){
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=mtl" class="judul"><i class="material-icons">mail</i> Monitoring Surat Lain</a></li>
                                            
                                        </ul>
                                    </div>
                                    <div class="col m5 hide-on-med-and-down">
                                        <form method="post" action="?page=mtl">
                ...
                <?php
                    ...
                    $perihal = mysqli_real_escape_string($config, $_REQUEST['perihal']);
                        ...
                        <div class="col s12" style="margin-top: -18px;">
                            <div class="card blue lighten-5">
                                ...
                                <p class="description">Hasil pencarian untuk kata kunci <strong>"'.stripslashes($cari).' '. stripcslashes($perihal).'"</strong><span class="right"><a href="?page=mtt"><i class="material-icons md-36" style="color: #333;">clear</i></a></span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            //$query = mysqli_query($config, "SELECT * FROM tbl_disposisilain WHERE status LIKE '%$cari%' ORDER by id_diposisilain DESC LIMIT $curr, $limit");
                             
                             $query = mysqli_query($config, "SELECT * FROM tbl_disposisilain WHERE  status LIKE '%$cari%' AND perihal LIKE '%$perihal%'  ORDER by id_disposisilain DESC LIMIT $curr, $limit");
                    ...
                    $query = mysqli_query($config, "SELECT * FROM tbl_disposisitlp");
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        <th width="10%">No.</th>
                                        <th width="20%">Perihal</th>
                                        <th width="24%">SKPD/UKPD<br/>Disposisi</th>
                                        <th width="18%">Tgl</th>
                                        <th width="18%">Keterangan</th>
                                                            ...
                                                            <div class="input-field col s12">
                                                                ...
                                                                <div class="modal-footer white">
                                                                    ...
                                                                    if(isset($_REQUEST['simpan'])){
                                                                        ...
                                                                        if($query == true){
                                                                            header("Location: ./admin.php?page=mtt");
                                                                            die();
                                                                        }
                                                                    } echo '
                               ...
                               $query = mysqli_query($config, "SELECT * FROM tbl_disposisilain ORDER by id_disposisilain DESC LIMIT $curr, $limit");
