                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=mtt" class="judul"><i class="material-icons">mail</i> Monitoring Telepon</a></li>
                                            
                                        </ul>
                                    </div>
                                    <div class="col m5 hide-on-med-and-down">
                                        <form method="post" action="?page=mtt">
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <div class="col s12" style="margin-top: -18px;">
                            <div class="card blue lighten-5">
                                ...
                                <p class="description">Hasil pencarian untuk kata kunci <strong>"'.stripslashes($cari).'"</strong><span class="right"><a href="?page=mtt"><i class="material-icons md-36" style="color: #333;">clear</i></a></span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr>
                                    <th width="10%">No.</th>
                                        ...
                                        <th width="18%">Nomor Telepon<br/>Tgl</th>
                            ...
                            //script untuk mencari data
                             $query = mysqli_query($config, "SELECT * FROM tbl_disposisitlp WHERE status LIKE '%$cari%' ORDER by id_diposisitlp DESC LIMIT $curr, $limit");
                    ...
                    if($cdata > $limit ){
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_disposisitlp ORDER by id_disposisitlp DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
