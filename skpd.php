                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">mail</i> Monitoring</a></li>
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk_skpd WHERE isi LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, $limit");
                    ...
                    $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk_skpd");
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        <th width="10%">No.</th>
                                        <th width="28%">No. Surat<br/>Tgl Surat</th>
                                         <th width="42%">Isi Ringkas<br/> File</th>
                                        <th width="20%">Status
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk_skpd ORDER by id_surat DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
