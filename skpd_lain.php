                    ...
                    echo '
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_disposisilain ORDER by id_diposisi DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                        ...
                                        $y = substr($row['tgl'],0,4);
                                        $m = substr($row['tgl'],5,2);
                                        $d = substr($row['tgl'],8,2);
