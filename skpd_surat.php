                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">mail</i> Monitoring Surat</a></li>
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        <th width="10%">No.</th>
                                        <th width="25%">Perihal<br/> File</th>
                                        
                                        <th width="25%">No. Surat<br/>Tgl Surat</th>
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                        ...
                                        if(!empty($row['attachment'])){
                                            echo ' <strong><a href="?page=gsm&act=fsm&id_surat='.$row['id_disposisi'].'">'.$row['attachment'].'</a></strong>';
                                        } else {
