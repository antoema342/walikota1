                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">mail</i> Surat Disposisi</a></li>
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk_staff WHERE isi LIKE '%$cari%' ORDER by id_surat DESC LIMIT $curr, $limit");
                        ...
                        <div class="col m12" id="colres">
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        <th width="10%">No.</th>
                                        <th width="20%">Perihal<br/> File</th>
                                        <th width="24%">SKPD/UKPD<br/> Keterangan</th>
                                        <th width="18%">No. Surat<br/>Tgl Surat</th>
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_disposisisurat where kepada = $where ORDER by id_disposisi DESC LIMIT $curr, $limit");
                                if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                        ...
                                        <td>';
                                         ...
                                         if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                                            ...
                                            echo '<a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih TL untuk Tindak Lanjut Surat" href="?page=tsm1&act=edit&id_surat='.$row['id_disposisi'].'">
                                                <i class="material-icons">description</i> EDIT</a>';}
                                                else{
                                            echo '<a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih TL untuk Tindak Lanjut Surat" href="?page=tsm1&act=ttl&id_surat='.$row['id_disposisi'].'">
                                                <i class="material-icons">description</i> TL</a>';}
                                        } else {
                                          echo '<a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih TL untuk Tindak Lanjut Surat" href="?page=tsm1telepon&act=ttlp&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">description</i> TL</a>';
                                        } echo ' 
                                                    <td>'.$row['status'].'</td>';
