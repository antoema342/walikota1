                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">mail</i> Telepon Disposisi</a></li>
                ...
                <?php
                    ...
                    $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                        ...
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_disposisitlp WHERE isi LIKE '%$cari%' ORDER by id_disposisi DESC LIMIT $curr, $limit");
                                ...
                                while($row = mysqli_fetch_array($query)){
                                  echo '
                                    ...
                                    if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                                      ...
                                      echo '<a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih Disp untuk menambahkan Disposisi Surat" href="?page=tsm&act=ttl&id_surat='.$row['id_surat'].'">
                    ...
                    $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk_staff");
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="22%">SKPD/UKPD<br/>Keterangan</th>
                                        <th width="18%">No.Telepon<br/>Tanggal</th>
                                ...
                                $query = mysqli_query($config, "SELECT * FROM tbl_disposisitlp where kepada = $where  ORDER by id_disposisitlp DESC LIMIT $curr, $limit");
                               if(mysqli_num_rows($query) > 0){
                                    $no = 1;
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                        ...
                                        <td>'.$row['skpd_ukpd'].'<br/><hr/>'.$row['keterangan'].'</td>';
                                      ...
                                      if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                                            ...
                                            echo '<a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih TL untuk Tindak Lanjut Surat" href="?page=tsm1telepon&act=edit&id_surat='.$row['id_disposisitlp'].'">
                                                <i class="material-icons">description</i> EDIT</a>';}
                                                else{
                                            echo '<a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih TL untuk Tindak Lanjut Surat" href="?page=tsm1telepon&act=ttl&id_surat='.$row['id_disposisitlp'].'">
                                                <i class="material-icons">description</i> TL</a>';}
                                        } else {
                                          echo '<a class="btn small light-green waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih TL untuk Tindak Lanjut Surat" href="?page=tsm1telepon&act=ttl&id_surat='.$row['id_surat'].'">
                                                    <i class="material-icons">description</i> TL</a>';
                                        } echo ' 
                                                    <td>'.$row['status'].'</td>';
