<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        die();
         ...
         <FORM METHOD="post" NAME="daftar" action="proses_disposisi_dll.php">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">description</i> Tambah Disposisi Lain</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="">
                    ...
                    <div class="input-field col s6">
                            ...
                            <input id="tgl_surat" type="text" name="tgl_lain" class="datepicker" required>
