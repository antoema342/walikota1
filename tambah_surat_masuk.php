                    ...
                    <div class="row">
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi dengan angka">
                            ...
                            <input id="no_agenda" type="number" class="validate" name="no_agenda" required>
                                ...
                                ?>
                            <label for="no_agenda">Asal Surat</label>
                        </div>
                        <div class="row">
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi dengan angka">
                            <i class="material-icons prefix md-prefix"></i>
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="sifat" id="sifat" required>
                                    <option value="Biasa">surat</option>
                                    <option value="Penting">telepon</option>
                                    <option value="Segera">dll.</option>
                                </select>
                            </div>
                                <?php
