<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        die();
         ...
         <FORM METHOD="post" NAME="daftar" action="proses_tl_lain.php">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">description</i> Tambah Tindak Lanjut Lain-lain</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            $where=$_SESSION['id_user'];
             $query = mysqli_query($config, "SELECT * FROM tbl_disposisilain where kepada = $where ORDER by id_disposisilain DESC "); 
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="">
                    ...
                    <div class="row">
                        <div class="col 6"><input type="hidden" name="id_disposisilain" value="<?php echo $_GET['id_surat'];?>">
