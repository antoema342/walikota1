<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        die();
         ...
         <FORM METHOD="post" NAME="daftar" action="proses_tl_tlp.php">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">description</i> Tambah Tindak Lanjut Telepon</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            $where=$_SESSION['id_user'];
             $query = mysqli_query($config, "SELECT * FROM tbl_disposisitlp where kepada = $where ORDER by id_disposisitlp DESC "); 
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="">
                    ...
                    <div class="row">
                        <div class="col 6"><input type="hidden" name="id_disposisitlp" value="<?php echo $_GET['id_surat'];?>">
