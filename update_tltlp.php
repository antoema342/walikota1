...
$sql = "UPDATE tbl_tl_tlp SET nama_staf='$nama_staf', skpd_ukpd='$skpd_ukpd', tlp='$tlp', ip_address='$ip_address', pengecekan_perbaikan='$pengecekan_perbaikan', p_perbaikanjaringan='$p_perbaikanjaringan', p_perangkatjaringan='$p_perangkatjaringan', pemakaian_bphtik='$pemakaian_bphtik', penjelasan_teknis='$penjelasan_teknis' where skpd_ukpd='$skpd_ukpd';";
$query = mysqli_query($config,$sql); 
if($query){
echo "Berhasil update data";  
header("location: edit_tltlp.php");
}
else{
echo 'Gagal';
}
